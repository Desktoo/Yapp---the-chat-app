...
import { Mail, MessageSquare, User, Lock, EyeClosed, Eye, Loader2 } from 'lucide-react';
          ...
          <form onSubmit={handleSubmit} className='space-y-6'>
            ...
            <div className="form-control">
              <label className='label mb-2.5'>
                <span className='label-text font-light'>Full Name</span>
              </label>
              <div className="relative">
                <div className="absolute z-20 inset-y-0 left-0 pl-2 flex items-center pointer-events-none">
